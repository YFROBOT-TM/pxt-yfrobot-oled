...
namespace YFOLED {
     ...
     * Clear
     */
    //% blockId=YFOLED_clear weight=3 blockGap=10
    ...
    /**
     * Draw Loading Bar
     * @param percent number. eg: 0
     */
    //% blockId=YFOLED_drawLoading weight=2 blockGap=10
     ...
     * @param n number. eg: 0
     */
    //% blockId=YFOLED_writeNum weight=5 blockGap=10
     ...
     */
    //% blockId=YFOLED_writeString weight=6 blockGap=10
    ...
    /**
     * Write Number New Line
     * @param n number. eg: 0
     */
    //% blockId=YFOLED_writeNumNewLine weight=7 blockGap=10
    //% block="show number %n"
    //% inlineInputMode=inline
     ...
     * @param str string. eg: hello
     */
    //% blockId=YFOLED_writeStringNewLine weight=8 blockGap=10
     ...
     * New Line
     */
    //% blockId=YFOLED_newLine weight=4 blockGap=10
     ...
     * @param y1 y1. eg: 20
     */
    //% blockId=YFOLED_drawLine weight=1 blockGap=10
     ...
     * @param y1 y1. eg: 20
     */
    //% blockId=YFOLED_drawRectangle weight=0 blockGap=10
    ...
    /**
     * Draw Rectangle
     * @param width x0. eg: 128
     * @param height y0. eg: 64
     */
    //% blockId=YFOLED_init weight=90 blockGap=10
